 ...
 * @Author wenzheng.liu
 * @Description
 * @ClassPath com.moko.lifex.activity.PowerReportPeriodActivity
 */
public class PowerReportPeriodActivity extends BaseActivity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (MokoConstants.ACTION_MQTT_RECEIVE.equals(action)) {
                ...
                if (mokoDevice.uniqueId.equals(msgCommon.id)) {
                    ...
                    if (msgCommon.msg_id == MokoConstants.MSG_ID_D_2_A_REPORT_INTERVAL) {
            ...
            if (AppConstants.ACTION_MODIFY_NAME.equals(action)) {
                MokoDevice device = DBTools.getInstance(PowerReportPeriodActivity.this).selectDevice(mokoDevice.deviceId);
    ...
    private void getPowerReportPeriod() {
        ...
        msgCommon.msg_id = MokoConstants.MSG_ID_A_2_D_GET_REPORT_INTERVAL;
    ...
    public void saveSettings(View view) {
        ...
        showLoadingProgressDialog(getString(R.string.wait));
        LogModule.i("设置电量上报间隔");
        MsgCommon<ReportPeriod> msgCommon = new MsgCommon();
        msgCommon.msg_id = MokoConstants.MSG_ID_A_2_D_SET_REPORT_INTERVAL;
        msgCommon.id = mokoDevice.uniqueId;
